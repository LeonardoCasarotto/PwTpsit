...
public:
    ...
    QAction *actionCambia_Directory;
    QAction *actionRicarica_Grafica;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCambia_Directory = new QAction(MainWindow);
        actionCambia_Directory->setObjectName("actionCambia_Directory");
        actionRicarica_Grafica = new QAction(MainWindow);
        actionRicarica_Grafica->setObjectName("actionRicarica_Grafica");
        ...
        menuPercorso->addAction(actionCambia_Directory);
        menuPercorso->addAction(actionRicarica_Grafica);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionCambia_Directory->setText(QCoreApplication::translate("MainWindow", "Cambia Directory", nullptr));
        actionRicarica_Grafica->setText(QCoreApplication::translate("MainWindow", "Ricarica Grafica", nullptr));
